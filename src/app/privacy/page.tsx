...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      sections={[
        ["Data we collect", "BuddyBin collects customer contact details, property details, bin schedule information and support tickets needed to arrange the service."],
